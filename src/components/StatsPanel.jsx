      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-400">
            Analyzing 225+ years of technological breakthroughs
          </p>
        </motion.div>
              ...
              ([category, count], index) => (
                ...
                >
                  <div
                    ...
                    } rounded-xl opacity-10 group-hover:opacity-20 transition-opacity blur-sm`}
                  />
                  <div className="relative bg-white/5 border border-white/10 rounded-xl p-4 group-hover:border-white/30 transition-all">
                    ...
                    <div className="mt-2 h-1 bg-white/10 rounded-full overflow-hidden">
                      <motion.div
                        initial={{ width: 0 }}
                        whileInView={{
                          width: `${(count / stats.totalMilestones) * 100}%`,
                        }}
                        viewport={{ once: true }}
